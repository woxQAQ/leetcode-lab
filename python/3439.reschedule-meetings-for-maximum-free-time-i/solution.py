# Created by woxQAQ at 2025/08/27 21:13
# leetgo: 1.4.15
...
你可以重新安排 **至多** `k` 个会议，安排的规则是将会议时间平移，且保持原来的 **会议时长** ，你的目的
是移动会议后 **最大化** 相邻两个会议之间的 **最长** 连续空余时间。
...
if __name__ == "__main__":
    ...
    ans = Solution().maxFreeTime(eventTime, k, startTime, endTime)
